...
from supply_list.cli import main
from supply_list.models import Note, ProjectState, Task
from supply_list.cli import demo_state
from supply_list.storage import load_state, save_state
from supply_list.models import generate_short_id
from supply_list.validation import normalize_tags, require_text, validate_task_status
from supply_list.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
